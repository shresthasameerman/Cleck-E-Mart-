<?php
// This file lets traders view and manage all the orders placed by customers for their shop's products.
            ...
            <aside class="admin-sidebar">
                ...
                <div class="admin-tabs">
                    <?php if ($shopId): ?>
                        ...
                        <a href="trader-sales.php?shop_id=<?php echo $shopId; ?>" class="tab-button">
